...
**Tu predicción**:  11 
**Resultado real**: 11
**Explicación**: prima la multiplicacion
...
```
**Tu predicción**: 9  
**Paso a paso**: prima la multiplicacion y luego la suma o resta
...
# calificaciones promedio 84.333....
...
# total a pagar por amigo 31.85

cuenta = 127.50
numero_amigos = 4

cuenta_pagar_individual = cuenta / numero_amigos

print(cuenta_pagar_individual)
...
print(f"Son {horas} horas con {minuto} minutos")
...
def main():
    ...
    carrera septima numero 19 - 48 edificio banco popular piso 10 scuela living natalia de gestio humana estar alla a la 1.00
